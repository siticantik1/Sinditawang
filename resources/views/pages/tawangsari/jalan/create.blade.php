            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nomor_ruas') is-invalid @enderror" name="nomor_ruas" value="{{ old('nomor_ruas') }}">
                        @error('nomor_ruas') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="form-group">
                        <label for="lokasi">Lokasi</label>
                        <textarea class="form-control @error('lokasi') is-invalid @enderror" name="lokasi" rows="2">{{ old('lokasi') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('status_tanah') is-invalid @enderror" name="status_tanah" value="{{ old('status_tanah') }}">
