...
<head>
    <meta charset="utf-8">
    <title>Laporan Inventaris Ruangan Tawangsari</title>
    <style>
...
<body>
    ...
    {{-- Menggunakan variabel $selectedRkt dan teks untuk Tawangsari --}}
    <p><strong>RUANGAN:</strong> {{ $selectedRkt->name ?? 'SEMUA RUANGAN (KEL. TAWANGSARI)' }}</p>
    ...
    <table class="table">
        ...
        <tbody>
            {{-- Menggunakan variabel $ikts untuk perulangan data --}}
            @forelse ($ikts as $item)
                <tr>
