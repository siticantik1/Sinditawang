...
@section('title', 'Tambah Data Ruangan Cikalang')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <h1 class="h3 mb-0 text-gray-800">Tambah Data Ruangan (Cikalang)</h1>
        ...
        <div class="col">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('cikalang.rkc.store') }}" method="POST">
                        @csrf
