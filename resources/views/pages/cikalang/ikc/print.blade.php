...
<head>
    <meta charset="utf-8">
    <title>Laporan Inventaris Ruangan Cikalang</title>
    <style>
...
<body>
    ...
    {{-- Menggunakan variabel $selectedRkc dan teks untuk Cikalang --}}
    <p><strong>RUANGAN:</strong> {{ $selectedRkc->name ?? 'SEMUA RUANGAN (KEL. CIKALANG)' }}</p>
    ...
    <table class="table">
        ...
        <tbody>
            {{-- Menggunakan variabel $ikcs untuk perulangan data --}}
            @forelse ($ikcs as $item)
                <tr>
