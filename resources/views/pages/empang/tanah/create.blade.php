...
<div class="card">
    <div class="card-header">
        <h3>Tambah Data Tanah - {{ ucfirst($lokasi) }}</h3>
    </div>
    <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('tahun_pengadaan') is-invalid @enderror" id="tahun_pengadaan" name="tahun_pengadaan" placeholder="Contoh: 2023" value="{{ old('tahun_pengadaan') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('hak') is-invalid @enderror" id="hak" name="hak" value="{{ old('hak') }}">
                        @error('hak')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nomor_sertifikat') is-invalid @enderror" id="nomor_sertifikat" name="nomor_sertifikat" value="{{ old('nomor_sertifikat') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('asal_usul') is-invalid @enderror" id="asal_usul" name="asal_usul" value="{{ old('asal_usul') }}">
                        @error('asal_usul')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('harga') is-invalid @enderror" id="harga" name="harga" placeholder="Contoh: 150000000" value="{{ old('harga') }}">
                        @error('harga')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
