...
<head>
    <meta charset="utf-8">
    <title>Laporan Inventaris Ruangan Empang</title>
    <style>
...
<body>
    ...
    {{-- Menggunakan variabel $selectedRke dan teks untuk Empang --}}
    <p><strong>RUANGAN:</strong> {{ $selectedRke->name ?? 'SEMUA RUANGAN (KEL. EMPANG)' }}</p>
    ...
    <table class="table">
        ...
        <tbody>
            {{-- Menggunakan variabel $ikes untuk perulangan data --}}
            @forelse ($ikes as $item)
                <tr>
