...
@section('title', 'Tambah Data Ruangan Kahuripan')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <h1 class="h3 mb-0 text-gray-800">Tambah Data Ruangan (Kahuripan)</h1>
        ...
        <div class="col">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('kahuripan.rkk.store') }}" method="POST">
                        @csrf
