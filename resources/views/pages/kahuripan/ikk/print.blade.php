...
<head>
    <meta charset="utf-8">
    <title>Laporan Inventaris Ruangan Kahuripan</title>
    <style>
...
<body>
    ...
    {{-- Menggunakan variabel $selectedRkk dan teks untuk Kahuripan --}}
    <p><strong>RUANGAN:</strong> {{ $selectedRkk->name ?? 'SEMUA RUANGAN (KEL. KAHURIPAN)' }}</p>
    ...
    <table class="table">
        ...
        <tbody>
            {{-- Menggunakan variabel $ikks untuk perulangan data --}}
            @forelse ($ikks as $item)
                <tr>
