...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    {{-- REVISI: Menambahkan sapaan selamat datang --}}
...
<!-- Content Row - Chart dan Aktivitas -->
<div class="row">
    ...
    <div class="col-xl-4 col-lg-5">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Aktivitas Inventaris Terbaru</h6>
            </div>
            <div class="card-body">
                @forelse ($recentInventaris as $item)
                    <div class="d-flex align-items-center pb-3 border-bottom mb-3">
                        ...
                        <div>
                            <div class="small text-gray-500">{{ $item->created_at->locale('id')->diffForHumans() }}</div>
                            <span class="font-weight-bold">
                                {{ $item->nama_barang }} ditambahkan ke ruang {{ $item->room->name ?? '' }}.
                            </span>
                        </div>
                    </div>
                @empty
...
var myLineChart = new Chart(ctx, {
  ...
  options: {
    ...
    scales: {
      ...
      yAxes: [{
        ticks: {
          maxTicksLimit: 5,
          padding: 10,
          // REVISI: Menghapus simbol '$' dari label sumbu Y
    ...
    tooltips: {
      ...
      caretPadding: 10,
      callbacks: {
        // REVISI: Menyesuaikan teks tooltip
