...
return new class extends Migration
{
    ...
    {
        Schema::create('ikts', function (Blueprint $table) {
            $table->id();
            $table->string('nama_barang');
            
            // Kolom ini akan terhubung ke tabel 'rkts'
            $table->foreignId('rkt_id')->constrained('rkts')->onDelete('cascade');
