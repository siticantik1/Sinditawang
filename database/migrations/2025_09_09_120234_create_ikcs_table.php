...
return new class extends Migration
{
    ...
    {
        Schema::create('ikcs', function (Blueprint $table) {
            $table->id();
            $table->string('nama_barang');
            
            // Kolom ini akan terhubung ke tabel 'rkcs'
            $table->foreignId('rkc_id')->constrained('rkcs')->onDelete('cascade');
